...
if __name__ == "__main__":
    ...
    encodedImage1=encode_image_to_base64("defonet_test_DJI_0004_hw_0_0.jpg") # test image for DefoNet
    ...
    time.sleep(6)#give servers time to start before sending first request.
    ...
    while current_time < duration:
        ...
        send_message(server_ip, server_port, "127.0.0.1", 5002, encodedImage1) #you will need to change port and 
